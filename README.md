...
| Project snapshot             | snapshotProject| snapproj        | -h, --help, -o, --output | Creates a timestamped project snapshot in `PROJECTS_PATH/ProjectZips`, excludes common non-essential folders, and prompts to optionally change to the output folder | [bash/snapshotProject.sh](./bash/snapshotProject.sh) |
