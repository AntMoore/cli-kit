...
| Select project               | selectproject  | sp, goproject, gpj |         | Shows a numbered list of project folders (with colors), prompts for a selection, then navigates into the chosen folder | [bash/selectproject.sh](./bash/selectproject.sh) |
